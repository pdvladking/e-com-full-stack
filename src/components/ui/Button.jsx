...
const variants = {
  primary:
    "bg-blue-600 text-white font-semibold shadow-md transition-transform hover:scale-110 hover:bg-blue-700 focus:ring-2",
  secondary:
    "bg-transparent border-2 border-blue-500 text-blue-700 font-semibold transition-colors hover:bg-blue-500 hover:text-white focus:ring-2",
};
